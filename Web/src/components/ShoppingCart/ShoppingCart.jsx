      ...
      <div className="mx-auto max-w-5xl justify-center px-6 md:flex md:space-x-6 xl:px-0">
        <div className="rounded-lg md:w-2/3">
          <div className="justify-between mb-6 rounded-lg dark:bg-gray-400 bg-white p-6 shadow-md sm:flex sm:justify-start">
            ...
            <div className="sm:ml-4 sm:flex sm:w-full sm:justify-between">
              <div className="mt-5 sm:mt-0">
                <h2 className="text-lg font-bold text-gray-900">Boat Headphone</h2>
          ...
          <div className="justify-between mb-6 rounded-lg dark:bg-gray-400 bg-white p-6 shadow-md sm:flex sm:justify-start">
            ...
            <div className="sm:ml-4 sm:flex sm:w-full sm:justify-between">
              <div className="mt-5 sm:mt-0">
                <h2 className="text-lg font-bold text-gray-900">Rocky Mountain</h2>
                <p className="mt-1 text-xs text-gray-700">Stock: 1</p>
              </div>
        ...
        <div className="mt-6 h-full rounded-lg border dark:bg-gray-400 bg-white p-6 shadow-md md:mt-0 md:w-1/3">
          ...
          <div className="flex justify-between">
            ...
            <div className="">
              <p className="mb-1 text-lg font-bold">$404.99 USD</p>
              <p className="text-sm text-gray-700">including tax</p>
            </div>
          </div>
          <button className="mt-6 w-full rounded-md bg-blue-500 py-1.5 font-medium text-blue-50 hover:bg-blue-600" onClick={handleCheck}>Check
            out
          </button>
        </div>
      </div>
