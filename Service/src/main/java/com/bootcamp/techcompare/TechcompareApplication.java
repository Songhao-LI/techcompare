...
import com.bootcamp.techcompare.repository.StoreProductRepository;
...
//			for (int i = 0; i < 50; i++) {
//				storeProductRepository.save(new StoreProduct(((int) (Math.random() * 100 + 1)), ((int) (Math.random() * 20 + 1))));
//			}
		};
	}
}
